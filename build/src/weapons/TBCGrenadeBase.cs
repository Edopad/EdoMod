...
{
    //[BaggedProperty("isInDemo", true), EditorGroup("guns|explosives")]
    public class TBCGrenadeBase : Gun
    {
        ...
        public TBCGrenadeBase(float xval, float yval) : base(xval, yval)
        {
            this.ammo = 1;
        ...
        {
            this.gr = TBCGrenadeBase.grenade;
            TBCGrenadeBase.grenade++;
        }
