namespace DuckGame.EdoMod
{
    ...
    public class MailGun : Gun
    {
        ...
        public MailGun(float xpos, float ypos)
          : base(xpos, ypos)
        {
            _editorName = "Mail Gun";

            // collision & sprite settings
            sprite = new SpriteMap(Mod.GetPath<EdoMod>("weapons\\mail_gun"), 16, 11);
            graphic = sprite;
